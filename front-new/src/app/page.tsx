    ...
    <div>
      <div className="w-screen h-screen justify-center content-center bg-gray-950">
        <div className="text-center content-center bg-center bg-bg_img bg-cover h-[70%]">
          ...
          <div className="mt-[15%]">
            <button className="w-44 h-16 bg-gray-950 rounded-lg hover:bg-pink-700" onClick={()=>router.push(PG.ADMIN+"/login")}>
              <div className="text-white font-medium font-['Inter'] leading-normal">Admin Login </div>
            </button>

            <button className="w-44 h-16 bg-gray-950 rounded-lg hover:bg-pink-700" onClick={()=>router.push(PG.USER+"/login")}>
              <div className="text-white font-medium font-['Inter'] leading-normal">User Login </div>
            </button>
