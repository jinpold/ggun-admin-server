...
export default function BoardCards() {
  ...
  const allBoards = [
    { id: 1, title: "사내게시판", description: "임직원 자유 게시판입니다. ", src:"http://localhost:3000/pages/articles/mylist/1", img: <CallIcon /> },
    { id: 2, title: "Q&A 게시판", description: "임직원 전용 Q&A 게시판입니다. ", src:"http://localhost:3000/pages/articles/mylist/2", img: <NewsIcon /> },
    { id: 3, title: "NEWS", description: "주식& 경제 뉴스입니다. ", src:"http://localhost:3000/pages/jusik/SE/news", img: <ListIcon /> },
    { id: 4, title: "통계 및 분석", description: "차트 게시판입니다. ", src:"", img: <ChartIcon /> },
  ];
